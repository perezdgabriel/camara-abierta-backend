...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('numero', 'anio', 'ministerio', 'categoria', name='uq_reglamentos_natural_key')
    )
    op.create_index(op.f('ix_reglamentos_content_fingerprint'), 'reglamentos', ['content_fingerprint'], unique=False)
    ...
    op.create_table('reglamentos_etapas',
    sa.Column('id', sa.BigInteger(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['reglamento_id'], ['reglamentos.id'], name=op.f('fk_reglamentos_etapas_reglamento_id_reglamentos'), ondelete='CASCADE'),
